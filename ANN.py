...
def train_nn_model(x_train, y_train, saveModelBoolean = True):
    ...
    for epoch in range(epochs):
        ...
        # if(saveModelBoolean):
        #     if(acc_valid >=0.99):
        #         modelName = "/Users/vinhxu/Desktop/gitBT/03_savedModel/.route1_11F-11F-11T-10T_Loss{0:.2f}_Accuracy{1:.01%}.ckpt".format(loss_valid, acc_valid)
        #         save_path = saver.save(sess, modelName)
        #         break

    if (saveModelBoolean):
        modelName = "/Users/vinhxu/Desktop/gitBT/03_savedModel/.route1_30k_8-8-8_Loss{0:.2f}_Accuracy{1:.01%}.ckpt".format(loss_valid, acc_valid)
        save_path1 = saver.save(sess, modelName)
        latestModelName = "/Users/vinhxu/Desktop/gitBT/03_savedModel/.Latest_route1_30k.ckpt".format(loss_valid, acc_valid)
...
# test_nn_model('./03_savedModel/.Latest_route1_1k.ckpt', dataName='train')
# test_nn_model('./03_savedModel/.Latest_route1_1k.ckpt', dataName='valid')
# test_nn_model('./03_savedModel/.Latest_route1_1k.ckpt', dataName='test')
