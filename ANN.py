...
h2 = 8   # Number of units in the second hidden layer
h3 = 8   # Number of units in the  hidden layer
...
def train_nn_model(x_train, y_train, saveModelBoolean = True):
    ...
    if (saveModelBoolean):
        modelName = "/Users/vinhxu/Desktop/gitBT/03_savedModel/.route3_10k_888_Loss{0:.2f}_Accuracy{1:.01%}.ckpt".format(loss_valid, acc_valid)
        save_path1 = saver.save(sess, modelName)
        latestModelName = "/Users/vinhxu/Desktop/gitBT/03_savedModel/.Latest_route3_10k.ckpt".format(loss_valid, acc_valid)
...
# routeCheck('./03_savedModel/.Latest_route1_1k.ckpt')
# routeCheck('./03_savedModel/.1nn_validation_Loss0.13_Accuracy97.1%.ckpt')
train_nn_model(x_train, y_train, saveModelBoolean=False)
# test_nn_model(loadModelBoolean=False)
# test_nn_model('./03_savedModel/.Latest_route3_10k.ckpt', dataName='train')
# test_nn_model('./03_savedModel/.Latest_route3_10k.ckpt', dataName='valid')
# test_nn_model('./03_savedModel/.Latest_route3_10k.ckpt', dataName='test')
